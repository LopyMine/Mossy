...
public class TranslateRenderAction implements IRenderAction {
	...
	public void render(RenderContext context, IRenderArgument... args) {
		context.stack().translate(Float.parseFloat(args[0].get()),Float.parseFloat(args[1].get()),Float.parseFloat(args[2].get()));
	}
}
